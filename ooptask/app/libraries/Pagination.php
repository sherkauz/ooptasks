<?php 
	...
	class Pagination{
		...
		private $db, $table, $sort, $total_records, $limit = 3, $col;

		//PDO connection
		public function __construct($table, $sort = 'name'){
			$this->table = $table;

            $this->sort = $sort;

			$this->db = new PDO("mysql:host=localhost; dbname=oopmvc", "root", "");
		...
		public function get_data(){
			...
			$query  = "SELECT * FROM $this->table ORDER BY $this->sort ASC LIMIT $start, $this->limit";
